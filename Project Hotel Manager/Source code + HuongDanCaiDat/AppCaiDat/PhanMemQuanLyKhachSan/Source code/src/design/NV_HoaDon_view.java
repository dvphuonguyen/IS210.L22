...
public class NV_HoaDon_view extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NV_HoaDon_view frame = new NV_HoaDon_view();
	...
	public NV_HoaDon_view() {
		...
		lblNewLabel_1.setBounds(329, 154, 88, 36);
		...
		panel_add_2_1_2.setBounds(437, 448, 224, 55);
...
//					mapdv = Integer.valueOf(String.valueOf(table.getValueAt(SelectedIndex, 6)) );
		...
		panel_add_2_1_1.setBounds(146, 448, 201, 55);
		...
		lbAdd_icon_4.setBounds(427, 154, 51, 43);
